(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global['ngx-echarts'] = {}, global.ng.core, global.rxjs, global.rxjs.operators));
    ...
    ***************************************************************************** */
    ...
    var NgxEchartsDirective = /** @class */ (function () {
        ...
        NgxEchartsDirective.prototype.ngOnInit = function () {
            ...
            this.resizeSub = this.resize$.pipe(operators.throttleTime(100, rxjs.asyncScheduler, { leading: false, trailing: true })).subscribe(function () { return _this.resize(); });
            if (this.autoResize) {
                this.resizeOb = this.ngZone.runOutsideAngular(function () { return new window.ResizeObserver(function () {
                    _this.animationFrameID = window.requestAnimationFrame(function () { return _this.resize$.next(); });
                }); });
